...
async function invoke() {
	...
	try {
		...
		// The medsys chaincode is able to perform a few functions
		//   'createdata' - requires 5 args, ex: args: ['data1', 'Jaemin', 'Date', 'Symptoms', 'Tom']
		//   'changedataOwner' - requires 2 args , ex: args: ['data10', 'Dave']
		const proposal_request = {
			targets: [peer],
			chaincodeId: 'medsys',
			fcn: 'createdata',
			args: ['data1', 'Jaemin', '20200223', 'CORONA19', 'Tom'],
			chainId: 'mychannel',
			txId: tx_id
		};
